...
def setntacl_file(fpath, fsd_dic):
    ...
    print "rsddl", rsddl
    smbd.set_nt_acl(fpath, security.SECINFO_OWNER | security.SECINFO_GROUP | security.SECINFO_DACL | security.SECINFO_SACL, security.descriptor.from_sddl(rsddl, security.dom_sid()) , service = None)
...
def setntacl_dir(dpath, dsd_dic):
    ...
    print "rsddl", rsddl
    smbd.set_nt_acl(dpath, security.SECINFO_OWNER | security.SECINFO_GROUP | security.SECINFO_DACL | security.SECINFO_SACL, security.descriptor.from_sddl(rsddl, security.dom_sid()) , service = None)
